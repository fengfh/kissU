...
var DD_belatedPNG = {
	...
	vmlOffsets : function(d) {
		...
		e(d.vml.color.shape, (n.L + (d.isImg ? 0 : n.bLW)), (n.T + (d.isImg
						? 0
						: n.bTW)), (n.W - 1), (n.H - 1), 0);
...
( function($){
	if(!$) return ;
	$.browserFix.register("ie","6","fixpng",function( target ){
	    DD_belatedPNG.fix(".pngfix,.pngfix:hover ,.pngfix img");
		$(target).find("img[src$='png']").each(function(){
